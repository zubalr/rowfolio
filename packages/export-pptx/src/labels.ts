...
const STRINGS: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "finding.downtime.title": "North downtime rose 31.1% from May to June, 1,194 to 1,565 minutes.",
  ...
  ar: {
    ...
    "finding.downtime.title": "ارتفع وقت التوقف في الشمال بنسبة ٣١٫١٪ من مايو إلى يونيو، من ١٬١٩٤ إلى ١٬٥٦٥ دقيقة.",
