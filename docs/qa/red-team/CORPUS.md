# Adversarial attack corpus inventory
...
| payload | where |
|---|---|
| zip entry `__proto__`/reserved names, `../evil.xml`, `C:/`, `a//b.xml`, dup names, 2000/2001 entries, 4MiB-zero bomb, truncated tails, declared-size lies | ingest-corpus |
...
| 20k×100 near-empty CSV over-envelope (refused) + 2k×100 within-limits (no blank-cell materialization) | amplification |
