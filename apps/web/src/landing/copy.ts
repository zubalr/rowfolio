...
const COPY: Record<CopyKey, Record<Locale, string>> = {
  ...
  "pres.credit": { en: "A project by Zubair Jashim, Computer Science graduate, Qatar University", ar: "مشروع من إعداد زبير جشيم، خريج علوم الحاسوب، جامعة قطر" },
  "pres.downloadPptx": { en: "Download PowerPoint", ar: "نزّل PowerPoint" },
  "pres.downloadXlsx": { en: "Download Excel", ar: "نزّل Excel" },
  "pres.explore": { en: "Open the example workspace", ar: "افتح مساحة عمل المثال" },
  ...
  "pres.invite.eyebrow": { en: "Bring your data", ar: "أحضر بياناتك" },
  ...
  "pres.output.mark": { en: "PowerPoint + Excel", ar: "PowerPoint وExcel" },
  ...
  "pres.watch": { en: "Watch the walkthrough", ar: "شاهد الجولة" },
  ...
  "action.openWorkspace": { en: "Open the example workspace", ar: "افتح مساحة عمل المثال" },
  "action.skipGuide": { en: "Skip · open the example workspace", ar: "تخطَّ الجولة · افتح مساحة عمل المثال" },
  ...
  "demo.step.brief.title": { en: "Get the briefing", ar: "احصل على الإحاطة" },
  "demo.step.inspect.action": { en: "Open the evidence", ar: "افتح الدليل" },
  "demo.step.inspect.body": { en: "Evidence opens the exact arithmetic and the worksheet rows behind the figure: rows 1802-1901 of the Operations sheet", ar: "يفتح الدليل العملية الحسابية الكاملة وصفوف ورقة العمل خلف الرقم: الصفوف من ١٨٠٢ إلى ١٩٠١ في ورقة Operations" },
  ...
  "landing.chart.summary": { en: "North is the visible exception: 881,000 against a 1,000,000 target; the other five regions sit within 4% of plan", ar: "الشمال هو الاستثناء الواضح: ٨٨١٬٠٠٠ مقابل مستهدف ١٬٠٠٠٬٠٠٠، بينما تقع المناطق الخمس الأخرى ضمن ٤٪ من الخطة" },
  "landing.chart.title": { en: "June revenue vs target by region", ar: "إيراد يونيو مقابل المستهدف حسب المنطقة" },
  "landing.specimen.note": { en: "A working slice of the product: the same parser, arithmetic and components the app uses, driven by the bundled sample", ar: "مقطع عملي من المنتج: المحلل والحسابات والمكوّنات الحقيقية نفسها، مدفوعة بالنموذج المضمّن" },
  ...
  "lead.kicker": { en: "Example walkthrough", ar: "جولة في مثال" },
  ...
  "pres.chapter.deliver": { en: "Take it with you", ar: "خذه معك" },
  ...
  "pres.check.dup": { en: "{n} duplicate rows excluded", ar: "استُبعد {n} من الصفوف المكررة" },
  "pres.check.dupTag": { en: "excluded", ar: "مستبعد" },
  "pres.check.missing": { en: "{n} optional survey cells left blank, never filled in", ar: "تُركت {n} من خلايا الاستبيان الاختيارية فارغة، لا تُملأ أبدًا" },
  ...
  "pres.evidence.span": { en: "{region} · June 2026 · {sheet} rows {start}-{end}", ar: "{region} · يونيو ٢٠٢٦ · صفوف {start}-{end} في {sheet}" },
  ...
  "pres.hand.body": { en: "Every figure below is computed by the real parser on the bundled sample. Step through it yourself", ar: "كل رقم أدناه يحسبه المحلل الحقيقي على النموذج المضمّن. تنقّل فيه بنفسك" },
  "pres.hand.title": { en: "The same engine, live in the page", ar: "المحرّك نفسه يعمل داخل الصفحة" },
  "pres.openWorkspace": { en: "Open the example workspace", ar: "افتح مساحة عمل المثال" },
  ...
  "pres.report.period": { en: "June 2026 · six regions · service operations", ar: "يونيو ٢٠٢٦ · ست مناطق · عمليات الخدمة" },
  ...
  "pres.scene.check.caption": { en: "Seventeen duplicate rows are excluded. Five optional survey cells stay blank; nothing is filled in.", ar: "تُستبعد سبعة عشر صفًا مكررًا. وتبقى خمس خلايا استبيان اختيارية فارغة؛ لا يُملأ شيء." },
  ...
  "pres.scene.transform.caption": { en: "Each value in the selected range becomes a mark on the chart: North June revenue against target", ar: "تتحوّل كل قيمة في النطاق المحدد إلى علامة على الرسم: إيراد الشمال لشهر يونيو مقابل المستهدف" },
  "pres.scene.transform.note": { en: "Each selected cell becomes one mark", ar: "كل خلية محددة تصبح علامة واحدة" },
  "pres.scene.transform.scope": { en: "{region} · June 2026 · revenue vs target", ar: "{region} · يونيو ٢٠٢٦ · الإيراد مقابل المستهدف" },
  ...
  "pres.task.period": { en: "The period: June 2026, one complete scheduled month", ar: "الفترة: يونيو ٢٠٢٦، شهر مجدول كامل" },
